namespace TakeOutManagement
{
	partial class TakeOrder
	{
		...
		private void InitializeComponent()
		{
			...
			// orderDataBinding
			// 
			this.orderDataBinding.DataSource = typeof(TakeOutManagement.Order);
			// 
			// panel2
			// 
			...
			this.demandDataGridViewTextBoxColumn.HeaderText = "跑腿需求";
			...
			this.startPointDataGridViewTextBoxColumn.HeaderText = "开始地点";
